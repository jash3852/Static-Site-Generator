...
class TestTextNode(unittest.TestCase):
    ...
    def test_proper_printing(self):
        node = TextNode("This is a text node", TextType.BOLD, "www.meow.com")
        self.assertEqual(str(node), "TextNode(This is a text node, bold, www.meow.com)")

    def test_not_eq(self):
        node = TextNode("This is a text node", TextType.BOLD, "www.meow.com")
        node2 = TextNode("This is a text node", TextType.BOLD, "www.bark.com")
